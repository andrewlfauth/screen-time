  ...
  return (
    <div className='flex justify-center h-screen py-32 lg:items-center bg-neutral-50'>
      <div className='px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl'>
        <Form
          method='post'
          className='p-10 pb-6 shadow border relative bg-white rounded-md w-[350px]'
        >
          {showError && (
            <Flash duration={5000}>
              <span className='absolute top-[10px] left-0 right-0 text-center font-semibold text-red-500'>
                {action.error}
              </span>
            </Flash>
          )}
          ...
          <Link
            to='/login'
            className='block px-4 mx-auto text-sm font-medium text-blue-500 w-fit'
          >
            Login
          </Link>
        </Form>
