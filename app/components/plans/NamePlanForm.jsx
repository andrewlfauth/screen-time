...
const NamePlanForm = forwardRef(function NamePlanForm(
  { currentPlan, goBack },
  ref
) {
  ...
  return (
    <Form method='post' className='max-h-[116px] mt-1'>
      ...
      <div className='flex justify-between mb-1'>
        <label htmlFor='planName' className='font-semibold text-blue-900'>
          Name your plan
        </label>
        {showSubmit && (
          <button
      ...
      <input
        ...
        className='w-full px-2 py-2 border rounded outline-blue-900 placeholder:text-sm'
        onChange={(e) =>
          e.target.value ? setShowSubmit(true) : setShowSubmit(false)
        }
      />
    </Form>
  )
