...
function ShowCard({ show, action = 'like', onClick, added }) {
  ...
  return (
    <div
      className={`${
        a.current.includes(show.title) ? 'hidden' : ''
      } flex flex-col shadow rounded-t-md max-w-[300px] md:w-auto`}
    >
      ...
      <div className='flex items-center justify-between px-2 py-1 bg-blue-900 shadow rounded-b-md'>
        ...
        <h3 className='relative flex items-center font-semibold tracking-tight text-white group cursor-help'>
